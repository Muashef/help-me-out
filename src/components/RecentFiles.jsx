...
function RecentFiles() {
  ...
  return (
    <div className="container mt-6 md:mt-8 flex justify-between items-end px-8 md:px-20 py-3">
      <div>
        <div>
          <p className="feat-four text-base md:text-lg font-medium text-[rgba(20,20,20,0.80)]">
            Recent Files
          </p>
