...
function Video() {
  return (
    <div className="pt-8">
      ...
      <VideoHeader />
      <div className="container flex flex-col md:flex-row gap-y-4 items-start md:items-center justify-between px-8 md:px-20 py-3">
        <div className="flex flex-col md:gap-2">
          <h1 className="feat-one text-2xl md:text-[2rem] font-bold text-[#141414]">
            Hello, John Mark
          </h1>
          <p className="feat-four font-normal text-base md:text-lg text-[rgba(20,20,20,0.70)]">
